    ...
    <Modal onClose={onClose} isVisible={isVisible}>
      <FlexBox column>
        <FlexBox className='mb-3 v-center' column>
          ...
          <Title className=''>Do you really wish to cancel without save the new changes?</Title>
        </FlexBox>

        <FlexBox className='v-center h-center'>
          <Button className='px-4 py-1 mr-5 danger-btn' onClick={onCancelEdits} disabled={saveLoading} onprogress={saveLoading}>Yes, cancel</Button>
