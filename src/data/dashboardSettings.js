...
const settings = {
  defaultCardsSettings: {
    sales: [
      ...
      { value: 'grossRevenue', label: 'Gross Revenue', show: true, format: '0.00', currency: '$' },
      ...
      { value: 'conversionRate', label: 'Conversion Rate', show: true, format: '0.0', currency: '%' },
      { value: 'views', label: 'Checkout Views', show: true, format: '0', currency: 'view' }
    ],
    refunds: [
      { value: 'refunds', label: 'Refunds', show: true, format: '0' },
      { value: 'refundRate', label: 'Refund Rate', show: true, format: '0.0', currency: '%' },
