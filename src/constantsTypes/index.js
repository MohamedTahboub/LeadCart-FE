...
/* SETTIGNS ACTIONS - GENRAL SETTING  */
export const SETTINGS_GENRAL_FIELD_UPDATE = Symbol('SETTINGS_GENRAL_FIELD_UPDATE');

export const SAVE_USER_GENRAL_SETTINGS = Symbol('SAVE_USER_GENRAL_SETTINGS');
export const SAVE_USER_GENRAL_SETTINGS_SUCCESS = Symbol('SAVE_USER_GENRAL_SETTINGS_SUCCESS');
export const SAVE_USER_GENRAL_SETTINGS_FAILD = Symbol('SAVE_USER_GENRAL_SETTINGS_FAILD');
/* SETTIGNS ACTIONS - GENRAL SETTING  ENDS */
...
export const TOGGLE_PRODUCT_PAYMENT = Symbol('TOGGLE_PRODUCT_PAYMENT');
export const TOGGLE_PRODUCT_PAYMENT_SUCCESS = Symbol('TOGGLE_PRODUCT_PAYMENT_SUCCESS');
export const TOGGLE_PRODUCT_PAYMENT_FAILD = Symbol('TOGGLE_PRODUCT_PAYMENT_FAILD');
