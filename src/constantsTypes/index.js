...
export const ADD_EMAIL_SOURCE = Symbol('ADD_EMAIL_SOURCE');
export const ADD_EMAIL_SOURCE_SUCCESS = Symbol('ADD_EMAIL_SOURCE_SUCCESS');
export const ADD_EMAIL_SOURCE_FAILED = Symbol('ADD_EMAIL_SOURCE_FAILED');
