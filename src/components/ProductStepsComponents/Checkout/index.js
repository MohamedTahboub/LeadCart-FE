      ...
      return (
        <MainBlock>
          <form className='products-details-form inputs-grounp section-block flex-row-wrap checkout-pages-designs'>
            ...
            <TemplatePreview active={false} image={tempImage3} onSelect={this.toggleTemplates} />
            <TemplatePreview active={false} image={tempImage4} onSelect={this.toggleTemplates} />
          </form>
        </MainBlock>
      );
    }
